...
#include <swag_msgs/trajectory_point.h>
...
public:
  ...
  void setVelocity(const swag_msgs::velocity_pairConstPtr &msg);
  void setVelocity(const swag_msgs::velocity_pair &msg);
  ...
  swag_msgs::trajectory_point toTrajectoryPoint(ros::Time stamp, const RobotControl &control, double axle_length) const;
   ...
   * @return
   */
  static double getArcLength(const swag_msgs::trajectory_point &a, const swag_msgs::trajectory_point &b);
};
