...
#include <swag_msgs/NavigateWaypointAction.h>
#include <swag_msgs/NavigateWaypointFeedback.h>
...
public:
  ...
  using GoalHandle = actionlib::ActionServer<swag_msgs::NavigateWaypointAction>::GoalHandle;
...
private:
  ...
  actionlib::ActionServer<swag_msgs::NavigateWaypointAction> action_server_;
  ...
  swag_msgs::NavigateWaypointFeedback move_base_feedback_;
  ...
  void runNextRecoveryBehavior(const swag_msgs::NavigateWaypointResult &navigate_waypoint_result);
};
