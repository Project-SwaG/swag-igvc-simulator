...
void speedCallback(const swag_msgs::velocity_pair::ConstPtr &msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher wheel_speed_publisher = handle.advertise<swag_msgs::velocity_pair>("/encoders", 1);
  ...
  while (ros::ok())
  {
    ...
    */
    ...
    swag_msgs::velocity_pair speed_measured;
